    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-[420px]">
        ...
        <div className="border border-line rounded-card bg-surface p-7">
          <h1 className="text-lg font-medium mb-1.5 text-center">Sign up</h1>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <label className="flex flex-col gap-2">
              ...
              <input type="password" required placeholder="Create a new password" className={inputCls} onChange={(e) => setPassword(e.target.value)} />
            </label>
            <label className="flex flex-col gap-2">
              <span className="text-sm text-muted">Repeat Password</span>
              <input type="password" required placeholder="Repeat the same password" className={inputCls} onChange={(e) => setRepeatPassword(e.target.value)} />
            </label>
